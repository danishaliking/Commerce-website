    ...
    <div class="container-fluid m-3">
        ...
        <div class="row d-flex justify-content-center ">
            ...
            <div class="col-lg-6 col-xl-4">
                <form action="../users_area/payment.php" method="post">
                    ...
                    <div>
                        ...
                        <p class="small fw-bold pt-1">Don't have you an account? <a href="admin_registration.php" class="link-danger">Register</a></p>
                    </div>
                </form>
            </div>
        </div>
